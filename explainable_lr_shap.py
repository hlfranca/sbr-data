...
for input_feature in ['Title']:
    for oversampler_name in oversamplers:
        ...
        for train, test in kf.split(train_X):
            ...
            test_input = np.array(train_X)[test]
            test_input = preprocessor.transform(test_input).toarray()
            ...
            explainer = shap.Explainer(classifier, current_inputs, feature_names=preprocessor.get_feature_names_out())
